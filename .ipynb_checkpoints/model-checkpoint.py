...
class NeuralNetwork:
    ...
    def update_parameters(self, learning_rate):
        ...
        self.parameters['b1'] = W1 - self.learning_rate * self.gradients['db1']
        self.parameters['W2'] = W1 - self.learning_rate * self.gradients['dW2']
        self.parameters['b2'] = W1 - self.learning_rate * self.gradients['db2']
    ...
    def fit(self, X, y, learning_rate = 0.1, num_iterations = 3000):
        self.learning_rate = learning_rate
        self.parameters = self.initialize_parameters(X.shape[0], 10, 10)
